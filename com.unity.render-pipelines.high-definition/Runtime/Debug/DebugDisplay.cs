...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public class DebugDisplaySettings : IDebugData
    {
        ...
        void RegisterLightingDebug()
        {
            ...
            {
                var probeVolumes = new DebugUI.Container() { displayName = "Probe Volumes" };

                probeVolumes.children.Add(new DebugUI.EnumField { displayName = "Probe Volumes Debug Mode", getter = () => (int)data.lightingDebugSettings.probeVolumeDebugMode, setter = value => SetProbeVolumeDebugMode((ProbeVolumeDebugMode)value), autoEnum = typeof(ProbeVolumeDebugMode), onValueChanged = RefreshLightingDebug, getIndex = () => data.probeVolumeDebugModeEnumIndex, setIndex = value => data.probeVolumeDebugModeEnumIndex = value });
                probeVolumes.children.Add(new DebugUI.EnumField { displayName = "Probe Volumes Atlas Slice Mode", getter = () => (int)data.lightingDebugSettings.probeVolumeAtlasSliceMode, setter = value => SetProbeVolumeAtlasSliceMode((ProbeVolumeAtlasSliceMode)value), autoEnum = typeof(ProbeVolumeAtlasSliceMode), onValueChanged = RefreshLightingDebug, getIndex = () => data.probeVolumeAtlasSliceModeEnumIndex, setIndex = value => data.probeVolumeAtlasSliceModeEnumIndex = value });
                probeVolumes.children.Add(new DebugUI.FloatField { displayName = "Probe Volumes Range Min Value", getter = () => data.lightingDebugSettings.probeVolumeMinValue, setter = value => data.lightingDebugSettings.probeVolumeMinValue = value });
                probeVolumes.children.Add(new DebugUI.FloatField { displayName = "Probe Volumes Range Max Value", getter = () => data.lightingDebugSettings.probeVolumeMaxValue, setter = value => data.lightingDebugSettings.probeVolumeMaxValue = value });
            
                list.Add(probeVolumes);
            }
            {
