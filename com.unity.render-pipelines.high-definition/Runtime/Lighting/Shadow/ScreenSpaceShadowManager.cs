    ...
    public partial class HDRenderPipeline
    {
            ...
            , RTHandle shadowHistoryArray)
        {
            ...
            for (int sampleIdx = 0; sampleIdx < additionalLightData.numRayTracingSamples; ++sampleIdx)
            {
                ...
                // Generate a new direction
                cmd.DispatchCompute(m_ScreenSpaceShadowsCS, shadowKernel, numTilesX, numTilesY, 1);
                ...
                // Evaluate the visibility
                cmd.DispatchRays(m_ScreenSpaceShadowsRT, m_RayGenShadowSegmentSingleName, (uint)hdCamera.actualWidth, (uint)hdCamera.actualHeight, 1);
            }
