...
namespace UnityEngine.Rendering
{
    ...
    /// <summary>
    /// The base class used for all parameters stored in <see cref="VolumeComponent"/>.
    /// </summary>
    ...
    public abstract class VolumeParameter
    {
        ...
        /// <summary>
        /// The current override state for this parameter. Overriden parameters will be considered
        /// for blending, non-overriden ones will be ignored.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// You can override this property to define custom behaviors when the override state is
        /// changed.
        /// </remarks>
        ...
        /// <remarks>
        /// This method is unsafe and will not do any type checking.
        /// </remarks>
        public T GetValue<T>()
        {
        ...
        /// <summary>
        /// Sets the value of this parameter to the value stored in <paramref name="parameter"/>.
        /// </summary>
        ...
        /// <summary>
        /// This method is called when the parent <see cref="VolumeComponent"/> is loaded.
        /// </summary>
        /// <remarks>
        /// This is used in case you need to access fields and properties that can't be accessed in
        /// the constructor of a <c>ScriptableObject</c> (<see cref="VolumeParameter"/> are
        /// generally declared and initialized in a <see cref="VolumeComponent"/> with is a
        /// <c>ScriptableObject</c>). This will be called right after the parent
        /// <see cref="VolumeComponent"/> has been constructed, thus allowing access to previously
        ...
        /// <summary>
        /// This method is called when the parent <see cref="VolumeComponent"/> goes out of scope.
        /// </summary>
    ...
    /// directly to declare parameters in <see cref="VolumeComponent"/>. Instead, use one of the
    ...
    public class VolumeParameter<T> : VolumeParameter, IEquatable<VolumeParameter<T>>
    {
        ...
        /// </summary>
        /// <param name="lhs">The first value stored in a <see cref="VolumeParameter"/></param>
        ...
        /// </summary>
        /// <param name="other">An other parameter to check against</param>
    ...
    /// <summary>
    /// A <see cref="VolumeParameter"/> that holds an <c>int</c> value that will be clamped to a
    /// minimum value.
    /// </summary>
    /// <seealso cref="IntParameter"/>
    /// <seealso cref="MaxIntParameter"/>
    ...
    /// <summary>
    /// A <see cref="VolumeParameter"/> that holds a non-interpolating <c>int</c> value that will be
    ...
    /// <summary>
    /// A <see cref="VolumeParameter"/> that holds a non-interpolating <c>int</c> value that will be
    /// clamped to a minimum and a maximum value.
    /// </summary>
    /// <seealso cref="IntParameter"/>
    /// <seealso cref="MinIntParameter"/>
    /// <seealso cref="MaxIntParameter"/>
    ...
    /// <summary>
    /// A <see cref="VolumeParameter"/> that holds a <c>float</c> value clamped to a minimum and a
    /// maximum value.
    /// </summary>
    /// <seealso cref="FloatParameter"/>
    /// <seealso cref="MinFloatParameter"/>
    ...
    /// <c>float</c> values clamped to a minimum and a maximum value.
    /// </summary>
    /// <seealso cref="FloatParameter"/>
    /// <seealso cref="MinFloatParameter"/>
    /// <seealso cref="MaxFloatParameter"/>
    ...
    /// a range of two <c>float</c> values clamped to a minimum and a maximum value.
    /// </summary>
    /// <seealso cref="FloatParameter"/>
    /// <seealso cref="MinFloatParameter"/>
    /// <seealso cref="MaxFloatParameter"/>
    ...
    public class ColorParameter : VolumeParameter<Color>
    {
        ...
        /// </summary>
        /// <param name="value">The initial value to be stored in the parameter</param>
        /// <param name="hdr">Is this color HDR?</param>
        /// <param name="showAlpha">Should the alpha channel be editable in the editor?</param>
        /// <param name="showEyeDropper">Should the eye dropper be visible in the editor?</param>
        /// <param name="overrideState">The initial override state for the parameter</param>
        ...
        /// </summary>
        /// <remarks>
        /// For performance reasons interpolation is done directly on the RGBA channels.
        /// </remarks>
        /// <param name="from">The start value</param>
        /// <param name="to">The end value</param>
        /// <param name="t">The interpolation factor in range [0,1]</param>
