...
namespace UnityEngine.Rendering
{
    ...
    public sealed class VolumeComponentMenu : Attribute
    {
        ...
        /// </summary>
        /// <param name="menu">The name of the entry in the orrice list. You can use slashes to
    ...
    /// <summary>
    /// The base class for all the components that will be part of a <see cref="VolumeProfile"/>.
    /// Any <see cref="VolumeParameter"/> members found in this class will be automatically handled
    /// and interpolated by the volume framework.
    /// </summary>
    /// <example>
    /// <code>
    ...
    {
        /// <summary>
        /// The active state of the set of parameters defined in this class. This can be used to
        /// quickly turn on or off all the overrides at once.
        /// </summary>
        public bool active = true;

        /// <summary>
        /// The name displayed in the component header. If none is set, it will generate one from
        /// the class name automatically.
        /// </summary>
        public string displayName { get; protected set; } = "";

        /// <summary>
        /// A read only collection of all the <see cref="VolumeParameter"/> defined in this class.
        /// </summary>
...
#pragma warning restore 414
        ...
        /// </summary>
        /// <remarks>
        /// You have to call <c>base.OnEnable()</c> if you intend to override it.
        /// </remarks>
        ...
        /// factor and put the result back into the given <see cref="VolumeComponent"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <see cref="VolumeParameter.SetValue"/> when setting parameter values and not assign
        /// directly to the state object and you should manually check
        /// <see cref="VolumeParameter.overrideState"/> before setting values.
        /// </remarks>
        /// <param name="state"></param>
        /// <param name="interpFactor"></param>
        /// <example>
        /// Here's how the default blending is implemented:
        /// <code>
        ...
        /// <summary>
        /// Sets all the overrides for this component to a given value.
        /// </summary>
        /// <param name="state">The value to set all the overrides to</param>
        ...
        /// <summary>
        /// A custom hashing function used to compared the state of parameters.
        /// </summary>
